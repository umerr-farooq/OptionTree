...
if ( ! class_exists( 'OT_Settings' ) ) {
    ...
    foreach ( $this->options as $option ) {
        ...
        $pages = $this->get_pages( $option );

        // Loop through pages.
        foreach ( (array) $pages as $page ) {
            
            // Check if $page is actually an array before accessing slug
            if ( ! is_array( $page ) || ! isset( $page['menu_slug'] ) ) {
                continue;
            }
            ...
            foreach ( (array) $sections as $section ) {
                ...
                // FIX: Ensure $section is an array before accessing its keys
